...
-- Keybind for Spawn Pallet
KeybindsGroup:AddLabel("📦 Pallet"):AddKeyPicker("SpawnPalletKey", {
    Default = "Z",
    Text = "Spawn Pallet under legs",
    NoUI = false,
    Callback = function() SpawnPalletUnderLegs() end
})
